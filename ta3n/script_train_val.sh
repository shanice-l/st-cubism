...
#====== select dataset ======#
path_data_root=xxx # depend on users
#path_exp_root=action-experiments/ # depend on users
path_exp_root=HCNPReLUtest_80epoch_Adam_noad_win64_seg4/ # depend on users
...
then
	...
	--gd $gd --lr $lr --lr_decay $lr_decay --lr_adaptive $lr_adaptive --lr_steps $lr_steps_1 $lr_steps_2 --epochs $epochs --optimizer $optimizer --weight_decay $weight_decay\
